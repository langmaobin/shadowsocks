...
public class MainActivity extends Activity implements
    ...
    private TextView textViewProxyUrl, textViewProxyApp,code;
    ...
    private void startPermissionSuccess() {
        ...
        if(imsi!=null){
            if(imsi.startsWith("46000") || imsi.startsWith("46002")|| imsi.startsWith("46007")){//因为移动网络编号46000下的IMSI已经用完，所以虚拟了一个46002编号，134/159号段使用了此编号
                //中国移动
                Toast.makeText(this,"中国移动",Toast.LENGTH_LONG).show();
            }else if(imsi.startsWith("46001")){
                //中国联通
                Toast.makeText(this,"中国联通",Toast.LENGTH_LONG).show();
            }else if(imsi.startsWith("46003")){
                Toast.makeText(this,"中国电信",Toast.LENGTH_LONG).show();
                //中国电信
            }
        }
    }
...
//        editText.setHint(getString(R.string.config_url_hint));
        editText.setText("ss://aes-256-cfb:Kef63GgTeW@18.162.193.193:16658");
